...
class ManageLVPEIUsers extends Component {
  ...
  componentDidMount () {
    this.props.ControlLvpeiUsers(this.props.match.params.id)
  }
...
ManageLVPEIUsers.propTypes = {
  ...
  ControlLvpeiUsers: PropTypes.func.isRequired
...
export default connect(mapStateToProps,{ControlLvpeiUsers})(ManageLVPEIUsers)